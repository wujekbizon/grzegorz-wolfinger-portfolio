...
const TailwindIcon: React.FC<IconAttributes> = ({
  width = 56,
  height = 56,
  primary = '#22D3EE',
  secondary = '#0891B2',
  ...
  return (
    <motion.svg
      animate={{ x: [-10, 10], y: [0, 10, -10, 0], opacity: [0, 1, 0] }}
      transition={{
        duration: 3,
        repeat: Infinity,
        repeatType: 'loop',
