      ...
      >
        <motion.div id="projects" variants={fadeIn('right', 'tween', 1, 1)} className={styles.project}>
          ...
          <motion.p variants={fadeIn('right', 'tween', 1.2, 1)} className={styles.content}>
            ...
            with the latest industry trends. I am now focusing on changing the web as we know it today by building more
            complex cross-platform applications and connecting them in a P2P network.
          </motion.p>
        </motion.div>
      </motion.div>
